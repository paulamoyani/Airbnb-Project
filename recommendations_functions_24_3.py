...
#        if val < median:
    ...
    #   Concatenating messages
        mess1 = "In order for your Airbnb to be truly competitive, make sure you fo the following things: "
...
print("-")
airbnb = pd.read_csv("X_wnei.csv").iloc[111].values.reshape(1,-1)
...
print("\nExample of airbnb that needs improvements according to our best model")
print("-")
airbnb = pd.read_csv("X_wnei.csv").iloc[100].values.reshape(1,-1)
recommendations(coefs, airbnb, X_wnei, data, recom)
print("____________________________________________________________________________________\n")
